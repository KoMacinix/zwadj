"""D310 — COPIE de `docs/preuves/D309/controles/controle-forme-chargily.py` (pièce de D309, non retouchée),
restreinte à ce que CE lot touche : les trois `.md` d'autorité écrits (`AGENTS.md`, `ZWADJ_CONTINUITE.md`,
`ZWADJ_BACKLOG.md`), tout `docs/preuves/D310/` (passe versée comprise). Contrôle de
FORME Chargily, À PART de l'audit (qui en est aveugle : décision 5 du relecteur, D304). Depuis la racine :

    python3 docs/preuves/D310/controles/controle-forme-chargily.py
...
for racine, _, noms in os.walk("docs/preuves/D310"):
