"""D307 — COPIE de `docs/preuves/D306/controles/controle-forme-chargily.py` (pièce de D306, non retouchée),
restreinte à ce que CE lot touche : les trois `.md` d'autorité écrits (`AGENTS.md`, `ZWADJ_CONTINUITE.md`,
`ZWADJ_BACKLOG.md`) et tout `docs/preuves/D307/`. Contrôle de FORME Chargily, À PART de l'audit (qui en est aveugle :
décision 5 du relecteur, D304). ⚠ Pertinent ici plus qu'ailleurs : ce lot parle des clés Chargily (faits de Ko).
Depuis la racine :

    python3 docs/preuves/D307/controles/controle-forme-chargily.py
...
for racine, _, noms in os.walk("docs/preuves/D307"):
