"""D312 — COPIE de `docs/preuves/D311/controles/controle-forme-chargily.py` (pièce de D311, non retouchée),
restreinte à ce que CE lot touche : les trois `.md` d'autorité écrits (`AGENTS.md`, `ZWADJ_CONTINUITE.md`,
`ZWADJ_BACKLOG.md`) et tout `docs/preuves/D312/`. Contrôle de FORME Chargily, À PART de l'audit (qui en est
aveugle : décision 5 du relecteur, D304). Depuis la racine :

    python3 docs/preuves/D312/controles/controle-forme-chargily.py

Formes et calibration reprises telles quelles (pièces de D305 à D311). ⛔ Aucune vraie clé : la calibration
...
for racine, _, noms in os.walk("docs/preuves/D312"):
