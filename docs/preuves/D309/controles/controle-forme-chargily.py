"""D309 — COPIE de `docs/preuves/D308/controles/controle-forme-chargily.py` (pièce de D308, non retouchée),
restreinte à ce que CE lot touche : les trois `.md` d'autorité écrits (`AGENTS.md`, `ZWADJ_CONTINUITE.md`,
`ZWADJ_BACKLOG.md`), tout `docs/preuves/D309/`, et la rectification posée à côté des pièces de D308. Contrôle de
FORME Chargily, À PART de l'audit (qui en est aveugle : décision 5 du relecteur, D304). Depuis la racine :

    python3 docs/preuves/D309/controles/controle-forme-chargily.py
...
cibles = ["AGENTS.md", "ZWADJ_CONTINUITE.md", "ZWADJ_BACKLOG.md", "docs/preuves/D308/portes/RECTIFICATION-D309.txt"]
for racine, _, noms in os.walk("docs/preuves/D309"):
