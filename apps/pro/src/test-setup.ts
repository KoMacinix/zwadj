...
const EXEMPTES: Record<string, string> = {
  "src/dashboard/walkin-journey.test.tsx": "64 avertissements act(…) — relevés le 22/08/2026 (lot S7)",
  "src/venues/venue-form.test.tsx": "6 avertissements act(…) — relevés le 22/08/2026 (lot S7)",
  "src/venues/venue-wizard.test.tsx": "3 avertissements act(…) — relevés le 22/08/2026 (lot S7)"
};
