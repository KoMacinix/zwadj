// Lot B6 — grille de calendrier PRO, D56. Jumelle de la spec client : les deux
// modules sont copiés (bundles séparés), donc les deux specs existent pour que
// toute dérive entre eux se voie immédiatement. Le test qui compte est le premier : en
